...
# ==========================================
# RENDER DB FIX
# Yeh line Render pe purani corrupt DB ko delete kar degi 
# jab bhi naya code deploy hoga, taaki naye columns add ho sakein.
# ==========================================
...
def get_db():
    # Fixed: 'in' ki jagah 'hasattr' use kiya hai
